...
public sealed class InnerJoinLens : ISymmetricLens<(Table, Table), Table>
{
    ...
    public Column LeftKey => _leftKey;
    public Column RightKey => _rightKey;
    public string JoinedTableName => _joinedTableName;
    public string DefaultLeftTableName => _defaultLeftTableName;
    public string DefaultRightTableName => _defaultRightTableName;
