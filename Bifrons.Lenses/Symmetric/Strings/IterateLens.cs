...
/// <c>iterate(R, L), L : string <=> string</c>
/// </summary>
public class IterateLens : BaseSymmetricLens<string, IEnumerable<string>>
{
    ...
    private IterateLens(string separatorRegexString, SymmetricStringLens itemLens)
    {
    ...
    /// <param name="separatorRegexString">String for separator regex</param>
    /// <param name="itemLens">Item lens to be applied on each item</param>
    public static IterateLens Cons(string separatorRegexString, SymmetricStringLens itemLens)
