...
INSERT INTO "Students" ("StudentID", "FirstName", "LastName", "Email", "PhoneNumber", "Major", "BillingAddress") VALUES
('A1B2C3D4E5', 'John', 'Doe', 'john.doe@example.com', '123-456-7890', 'Computer Science', '123 Main St, City, State, ZIP'),
('F6G7H8I9J0', 'Jane', 'Smith', 'jane.smith@example.com', '987-654-3210', 'Mathematics', '456 Oak St, City, State, ZIP'),
('K1L2M3N4O5', 'Alice', 'Brown', 'alice.brown@example.com', '123-456-7891', 'Physics', '789 Pine St, City, State, ZIP'),
('P6Q7R8S9T0', 'Bob', 'Johnson', 'bob.johnson@example.com', '987-654-3211', 'Chemistry', '321 Elm St, City, State, ZIP'),
('U1V2W3X4Y5', 'Charlie', 'Davis', 'charlie.davis@example.com', '123-456-7892', 'Biology', '654 Willow St, City, State, ZIP');
