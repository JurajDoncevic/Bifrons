...
public class InnerJoinLensTests : SymmetricLensTestingFramework<(Table, Table), Table>
{
    ...
    protected override ((Table, Table) originalSource, Table expectedOriginalTarget, Table updatedTarget, (Table, Table) expectedUpdatedSource) _roundTripWithRightSideUpdateData => throw new NotImplementedException();

    protected override (Table originalSource, (Table, Table) expectedOriginalTarget, (Table, Table) updatedTarget, Table expectedUpdatedSource) _roundTripWithLeftSideUpdateData => throw new NotImplementedException();
